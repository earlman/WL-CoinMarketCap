 ...
 */
Module.register("WL-CoinMarketCap", {
    /**
    ...
    start: function () {
        ...
        self.logosURLTemplate =
            self.assetsBaseURL + "static/img/coins/{size}x{size}/{id}.png";
        self.graphURLTemplate =
            self.assetsBaseURL +
            "generated/sparklines/web/{range}d/usd/{id}.png?noCache={noCache}";
        ...
        switch (colType) {
            ...
            case "price":
                ...
                if (
                    ...
                    priceOptions.minimumFractionDigits = priceOptions.maximumFractionDigits =
                        currency.decimalPlaces;
